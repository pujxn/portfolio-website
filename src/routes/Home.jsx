    ...
    return (
        <motion.div variants={containerVariant} initial="hidden" animate="visible" className="w-4/5 ml-32">
            ...
            <div className="text-2xl w-3/5">
                ...
                <p className="text-light-gray">{splitToSpan({ str: "I'm currently " })}{splitToSpan({ str: "looking for opportunites", className: "text-light-orange" })}{splitToSpan({ str: " with motivated teams to build delightful and performant experiences for the user." })}</p>
            </div>
            <div className="w-full">
                <button className="shadow-xl p-3 mt-16 text-2xl border-2 border-light-orange text-light-orange">Get in touch!</button>
            </div>
        </motion.div >
    )
}
