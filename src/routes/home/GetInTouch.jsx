...
const GetInTouch = () => {
    ...
    return (
        <div className="ml-2 w-fit relative mt-8">
            <motion.button
                variants={buttonVariant}
                whileHover={{ x: "-0.5rem", transition: { duration: 0.3, ease: "easeInOut" } }}
                className="bg-deep-purple z-10 p-3 relative shadow-xl w-full h-full text-2xl border-2 border-light-orange text-light-orange">Get in touch!</motion.button>
